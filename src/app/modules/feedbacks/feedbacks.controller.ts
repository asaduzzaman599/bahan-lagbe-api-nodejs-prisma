...
const insertFeedback = catchAsync(async (req, res) => {
  ...
  return responseData({ message: "Feedback inserted  successfully", result }, res);
});
...
const updateFeedback = catchAsync(async (req, res) => {
  ...
  return responseData({ message: "Feedback updated  successfully", result }, res);
});
...
const deleteFeedback = catchAsync(async (req, res) => {
  ...
  return responseData({ message: "Feedback deleted  successfully", result }, res);
});
...
const findOneFeedback = catchAsync(async (req, res) => {
  ...
  return responseData({ message: "Feedback fetched successfully", result }, res);
});

const findFeedbacks = catchAsync(async (req, res) => {
  const result = await FeedbackService.findFeedbacks();
  return responseData({ message: "Feedbacks retrieved successfully", result }, res);
});
