...
const insertFeedback = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (feedbackExist)
        throw new api_error_1.default(http_status_1.default.CONFLICT, 'Feedback already exist!');
...
const updateFeedback = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!feedbackExist)
        throw new api_error_1.default(http_status_1.default.NOT_FOUND, 'Feedback not exists');
...
const deleteFeedback = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!feedbackExist)
        throw new api_error_1.default(http_status_1.default.NOT_FOUND, 'Feedback not exists');
    const feedback = yield prisma_client_1.default.feedback.delete({
        where: {
            id
        }
    });
