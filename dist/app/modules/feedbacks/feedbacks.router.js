...
router.route('/create-feedback').post((0, validate_request_1.default)(feedbacks_validation_1.FeedbackValidation.createFeedbackZodSchema), (0, auth_1.default)(client_1.Role.customer, 'public'), feedbacks_controller_1.FeedbackController.insertFeedback);
router.route('/')
    .get(feedbacks_controller_1.FeedbackController.findFeedbacks);
router.route('/:id')
