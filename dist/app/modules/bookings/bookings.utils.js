...
const calculateTotal = (startDate, endDate, vehicleId) => __awaiter(void 0, void 0, void 0, function* () {
    const vehicle = yield prisma_client_1.default.vehicle.findUnique({
        where: {
            id: vehicleId,
            status: {
                not: client_1.VehicleStatus.NOTAVAILABLE
            }
        }
    });
    if (!vehicle)
        throw new api_error_1.default(http_status_1.default.NOT_FOUND, "Vehicle Not found");
