...
const findBookings = (0, catch_async_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, response_1.default)({ message: "Bookings retrieved successfully", result: { result: result.data, meta: result.meta } }, res);
}));
const findBookingByVehicle = (0, catch_async_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const vehicleId = req.params.vehicleId;
    const query = req.query;
    const paginationOptions = (0, pick_1.default)(query, ['page', 'size', 'sortBy', 'sortOrder']);
    const filterOptions = (0, pick_1.default)(query, ['minTotal', 'maxTotal', 'minRating', 'rating', 'status']);
    filterOptions.vehicleId = vehicleId;
    const result = yield bookings_service_1.BookingService.findBookings(user, filterOptions, paginationOptions);
    return (0, response_1.default)({ message: "Booking with associated Vehicles data fetched successfully", result: { result: result.data, meta: result.meta } }, res);
}));
